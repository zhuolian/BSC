...
1）NAME_: FenHong（填写代币名称）

2）symbol_: FH （填写代币简称）

3）TOTALSUPPLY_: 100000000(发行总量，发多少就写多少)

4）REWARDADDR_:(要分红的代币合约，分红哪个代币，就填哪个代币的合约地址)
...
5）MARKETINGWALLETADDR_:(填写自己的市场营销钱包地址) 

6）BUYFEESETTING_:[4,3,2,1]，买入收取手续费比例：分别为(分红、流动性、市场营销、销毁燃烧)

7）SELLFEESETTING_: [5,4,3,2]，卖出收取手续费比例：分别为(分红、流动性、市场营销、销毁燃烧)

注意：上述四个手续费参数可以任意设置，但是总和不能超过25%，例如[10,10,10,10]总和为40%，部署就会失败。

8）TOKENBALANCEFORREWARD_: 1000000000000000000(1后面+18个0)，持有多少代币以上才会参与分红。
